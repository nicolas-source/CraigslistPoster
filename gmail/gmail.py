...
# from utf import encode as utf9encode, decode as utf9decode
from utf9 import utf9encode, utf9decode
...
class Gmail():
    ...
    def mailbox(self, mailbox_name):
        if mailbox_name not in self.mailboxes:
            mailbox_name = utf9encode(mailbox_name)
    ...
    def labels(self, require_unicode=False):
        ...
        if require_unicode:
            keys = [utf9decode(key) for key in keys]
        return keys
